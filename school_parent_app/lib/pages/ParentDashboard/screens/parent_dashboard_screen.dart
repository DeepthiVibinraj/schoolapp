...
//                       timeNow <= 12
//                           ? 'Good Morning!'
//                           : ((timeNow > 12) && (timeNow <= defaultPadding))
//                               ? 'Good Afternoon!'
//                               : 'Good Evening!',
...
//           crossAxisAlignment: CrossAxisAlignment.start,
//           children: [
//             // Curved Header Section with Horizontal ListView
//             ClipPath(
//               clipper: WaveClipper(),
//               child: Container(
//                 width: size.width,
...
//                       child: Obx(() {
//                         // Debug print to confirm reactive changes
//                         print(
...
//                             // Debug print to confirm `isActive` calculation
...
//                                 // Debug print to confirm the tap works
...
//                           Text(
//                             'This is a brief description of the notification. You can tap to see more details.',
//                             style: TextStyle(
...
//                   trailing: Icon(Icons.arrow_forward_ios, size: defaultPadding),
//                 );
//               },
//             ),
//           ],
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child:
            ...
            //       right: defaultPadding,
            //       top: size.height *
            //           0.16, // Adjust to balance overlap between sections
            //       child: Container(
            ...
            // ),
            SizedBox(
              height: size.height * 0.3, // Adjust this to fit the student list
              child: Stack(
                clipBehavior:
                    Clip.none, // Ensures overflowing content is visible
                children: [
                  ClipPath(
                    clipper: StraightClipper(),
                    child: Container(
                      width: size.width,
                      height: size.height *
                          0.23, // Increase height for better visibility
                      color: colorScheme.primary,
                      padding: const EdgeInsets.symmetric(
                        horizontal: defaultPadding,
                        //vertical: defaultPadding * 2,
                  ...
                  Positioned(
                    left: 0,
                    right: 0,
                    top: size.height * 0.14, // Move the list slightly down
                    child: Container(
                      height: size.height * 0.18,
                      decoration: BoxDecoration(
                          //borderRadius: BorderRadius.circular(defaultPadding),
...
//       body: Stack(
//         children: [
//           // Background with a straight line header
//           ClipPath(
//             clipper: StraightClipper(),
//             child: Container(
//               width: size.width,
...
//           // Positioned student container in the middle
//           Positioned(
//             top: size.height * 0.15, // Adjust for middle positioning
//             left: defaultPadding,
//             right: defaultPadding,
//             child: Container(
//               padding: const EdgeInsets.all(defaultPadding),
...
// Custom Clipper for a straight header
