...
import 'package:school_parent_app/core/theme/synap/widgets/page_under_construction.dart';
...
//           // Wrap ListView in Expanded & SingleChildScrollView
//           Expanded(
//             child: SingleChildScrollView(
//               child: Column(
//                 children: [
...
//                       onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.calendar_month, text: 'Events', onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.table_view, text: 'TimeTable', onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.school, text: 'Exam', onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.fact_check, text: 'Attendance', onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.settings, text: 'Settings', onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.help_outline, text: 'Help', onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.school, text: 'Exam', onTap: () {}),
//                   _buildDrawerItem(
//                       icon: Icons.fact_check, text: 'Attendance', onTap: () {}),
